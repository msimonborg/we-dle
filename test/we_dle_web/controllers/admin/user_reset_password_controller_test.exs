defmodule WeDleWeb.Admin.UserResetPasswordControllerTest do
  ...
  describe "GET /admin/users/reset_password" do
  ...
  describe "POST /admin/users/reset_password" do
    @tag :capture_log
  ...
  describe "GET /admin/users/reset_password/:token" do
    setup %{user: user} do
      token =
  ...
  describe "PUT /admin/users/reset_password/:token" do
    setup %{user: user} do
      token =
        extract_user_token(fn url ->
          Accounts.deliver_user_reset_password_instructions(user, url)
