defmodule WeDleWeb.Admin.UserSessionControllerTest do
  ...
  describe "GET /admin/users/log_in" do
    ...
    test "redirects if already logged in", %{conn: conn, user: user} do
      conn = conn |> log_in_user(user) |> get(Routes.admin_user_session_path(conn, :new))
  ...
  describe "POST /admin/users/log_in" do
    ...
    test "logs the user in with remember me", %{conn: conn, user: user} do
      ...
      assert conn.resp_cookies["_we_dle_web_user_remember_me"]
      assert redirected_to(conn) == "/"
    end
  ...
  describe "DELETE /admin/users/log_out" do
    test "logs the user out", %{conn: conn, user: user} do
      conn = conn |> log_in_user(user) |> delete(Routes.admin_user_session_path(conn, :delete))
      assert redirected_to(conn) == "/"
