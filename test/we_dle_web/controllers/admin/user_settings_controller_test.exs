defmodule WeDleWeb.Admin.UserSettingsControllerTest do
  ...
  describe "GET /admin/users/settings" do
  ...
  describe "PUT /admin/users/settings (change password form)" do
  ...
  describe "PUT /admin/users/settings (change email form)" do
    @tag :capture_log
  ...
  describe "GET /admin/users/settings/confirm_email/:token" do
    setup %{user: user} do
